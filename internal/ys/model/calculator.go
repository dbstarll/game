...
func NewCalculator(character *Character, enemy *Enemy, action *Action, infusionElemental elemental.Elemental) *Calculator {
	calculator := &Calculator{
		...
		basicAttributes:   character.basicAttributes(),
...
func (c *Calculator) set(key string, value float64) (float64, bool) {
...
func (c *Calculator) calculate() {
	...
	c.set("人物等级", float64(c.level))
	c.set("怪物等级", float64(c.enemy.level))
